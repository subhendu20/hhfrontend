...
function Userprofile() {
          ...
          const followuser = () => {
                    if (follow === 'follow') {
                              axios.get(`https://helping-hand-backend.onrender.com/comment/addfollow/${userId}`, {
                              ...
                              axios.get(`https://helping-hand-backend.onrender.com/comment/removefollow/${userId}`, {
                                        withCredentials: true
                              }).then(async (res) => {
                                        console.log(res.data)
                                        setfollow('Follow')
          ...
          useEffect(() => {
                    setfollowloading(true)
                    axios.get(`https://helping-hand-backend.onrender.com/comment/followerlist/${userId}`, {
                              withCredentials: true
                    }).then(async (res) => {
                              setfollowerlist({
                                        followers: res.data
          ...
          useEffect(() => {
                    setfollowloading(true)
                    axios.get(`https://helping-hand-backend.onrender.com/comment/followcheck/${userId}`, {
                              withCredentials: true
                    }).then(async (res) => {
                              console.log(res.data)
          ...
          useEffect(() => {
                    ...
                    axios.post('https://helping-hand-backend.onrender.com/users/getdetails', { userId }, {
                              withCredentials: true
                    }).then((res) => {
                              console.log(res.data)
                              setprofiledata({
          ...
          useEffect(() => {
                    ...
                    axios.post('https://helping-hand-backend.onrender.com/post/postlist', { userId }, {
                              withCredentials: true
                    }).then(async (res) => {
